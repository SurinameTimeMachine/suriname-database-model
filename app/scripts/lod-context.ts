...
export function buildContext(): Record<string, unknown> {
  return {
    ...
    PersonObservation: 'picom:PersonObservation',
    ...
    idPerson: { '@id': 'dcterms:identifier', '@type': 'xsd:string' },
    idSource: { '@id': 'dcterms:identifier', '@type': 'xsd:string' },
    sex: { '@id': 'stm:sex', '@type': 'xsd:string' },
    dayBirth: { '@id': 'stm:dayBirth', '@type': 'xsd:integer' },
    monthBirth: { '@id': 'stm:monthBirth', '@type': 'xsd:integer' },
    yearBirth: { '@id': 'stm:yearBirth', '@type': 'xsd:gYear' },
    dayDeath: { '@id': 'stm:dayDeath', '@type': 'xsd:integer' },
    ...
    startDay: { '@id': 'stm:startDay', '@type': 'xsd:integer' },
    startMonth: { '@id': 'stm:startMonth', '@type': 'xsd:integer' },
    startYear: { '@id': 'stm:startYear', '@type': 'xsd:gYear' },
    startEvent: { '@id': 'stm:startEvent', '@type': 'xsd:string' },
    startInfo: { '@id': 'stm:startInfo', '@type': 'xsd:string' },
    endDay: { '@id': 'stm:endDay', '@type': 'xsd:integer' },
    endMonth: { '@id': 'stm:endMonth', '@type': 'xsd:integer' },
    endYear: { '@id': 'stm:endYear', '@type': 'xsd:gYear' },
    endEvent: { '@id': 'stm:endEvent', '@type': 'xsd:string' },
    endEventDetailed: { '@id': 'stm:endEventDetailed', '@type': 'xsd:string' },
    endInfo: { '@id': 'stm:endInfo', '@type': 'xsd:string' },
    registerType: { '@id': 'stm:registerType', '@type': 'xsd:string' },
    inventoryNumber: { '@id': 'stm:inventoryNumber', '@type': 'xsd:string' },
    folioNumber: { '@id': 'stm:folioNumber', '@type': 'xsd:string' },
