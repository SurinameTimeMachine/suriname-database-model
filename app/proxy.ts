...
const RESOURCE_PREFIX =
  '(?:appellation|database|feature|image|inference|obs|organization|organization-composition|place|plantation|production|provenance|rule|source|timespan|type|visual-item|vocabulary)';
