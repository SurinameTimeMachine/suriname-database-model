...
P139 links "Geijersvlijt" (map label) to "Geyers-Vlijt" (almanac name) as alternative forms of each other. This does _not_ mean E25 and E74 are the same entity. It means: these two names, despite their different spellings and different referent types, ultimately trace back to the same real-world referent complex. The plantation (E25) and organization (E74) have a researched QID association, while their names are connected through P139.
...
## Layer 7 --- Space and Organizational Association

**Relationships:**

- `E25 Human-Made Feature --P53 has former or current location--> E53 Place`
- `E25 Human-Made Feature --stm:hasOrganizationalAssociation--> E74 Group`
- `E74 Group --stm:associatedPhysicalPlantation--> E25 Human-Made Feature`
...
flowchart LR
    ...
    E25 -->|"has organizational association"| E74_ORG
    E74_ORG -->|"associated physical plantation"| E25
...
The final layer grounds the model in space and connects the distinct physical
and organizational records without turning the correspondence into ownership.
...
The paired STM properties connect the physical plantation to the organization
identified by the same researched QID. This is the relationship that makes E25
and E74 discoverable without treating them as one dual-typed entity.

Why separate them? Because they change independently:

- A plantation can change owners while the land and fixed works remain the same.
- An organization can merge or dissolve while the E25 keeps its physical boundaries.
- A plantation can be abandoned. The E25 still exists (you can still see its remains), but no E74 currently operates it.

The QID is an exact authority match for the E74 and a close match for the E25.
P51/P52 ownership and E68/E81 change events are added only from reviewed,
dated evidence.
...
flowchart TB
    ...
    %% Layer 7: Location and organizational association
    E25 -->|"P53 has location"| E53
