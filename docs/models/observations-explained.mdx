...
When `has_parts1_id = Q59115689` on the row for `plantation_id = Q4392658`, it records:
...
Some plantations are part of larger merged combinations. The `part_of_lab` / `part_of_id` columns record this:
